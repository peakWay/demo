...
// mixin MultipleListFetchs<T extends StatefulWidget, D extends List> on FetchState<T, D> {
...
//   Future<D> fetch<String>([String arg]);
...
//     super.fetchIfNeed(_map[selectedType]);
//   }
// }

mixin MultipleListFetchs<T extends StatefulWidget, D extends List> on State<T>, FetchState<D> {
  String get selectedType => _selectedType;
  String _selectedType;
  set selectedType(String value) {
    assert(_types.contains(value));
