...
class _RenderCupertinoSwitch extends RenderConstrainedBox {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    ///初始化静态数据
    double trackRadius;
    double trackInnerStart = _kTrackInnerStart;
    double trackInnerEnd = _kTrackInnerEnd;
    ...
    final Rect trackRect = Rect.fromLTWH(
        offset.dx + (size.width - trackWidth ?? _kTrackWidth) / 2.0,
        offset.dy + (size.height - trackHeight ?? _kTrackHeight) / 2.0,
    ...
    ///替换CupertinoThumbPainter.radius 为 trackHeight / 2 - 2
    final double currentThumbExtension = CupertinoThumbPainter.extension * currentReactionValue;
    double _radiu = trackHeight != null ? (trackHeight / 2 - 2) : CupertinoThumbPainter.radius;
    final double thumbLeft = lerpDouble(
      trackRect.left + trackInnerStart - _radiu,
      trackRect.left + trackInnerEnd - _radiu - currentThumbExtension,
      visualPosition,
    );
    final double thumbRight = lerpDouble(
      trackRect.left + trackInnerStart  + _radiu + currentThumbExtension,
      trackRect.left + trackInnerEnd + _radiu,
      visualPosition,
    );
